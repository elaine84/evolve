...
\conferenceinfo{ITCS}{'14 Princeton, New Jersey, USA}
...
\category{Theory of computation}{Theory and algorithms for application
domains}{Machine learning theory}
%\category{Machine Learning Theory}

\terms{Evolvability, Computational Learning Theory, Compressed Sensing}
